...
public class DelegatingResultSet implements ResultSet {
     ...
     * DelegatingResultSet}'s {@linkplain #isCloseable() closeable}
     * status
     *
     * @param strictClosedChecking if {@code true}, then <em>this</em>
     * {@link DelegatingResultSet}'s {@link #isClosed()} method will
    ...
    /**
     * Returns the {@link ResultSet} to which all operations will be
     * delegated.
     *
     * <p>This method never returns {@code null}.</p>
     *
     * @return the {@link ResultSet} to which all operations will be
    ...
    /**
     * Ensures this {@link DelegatingResultSet} is {@linkplain
     * #isClosed() not closed}, if {@linkplain
     * #DelegatingResultSet(Connection, ResultSet, boolean, boolean)
     ...
     * it.</p>
     *
     * @exception SQLException if this {@link DelegatingResultSet} was
     * {@linkplain #DelegatingResultSet(Connection, ResultSet,
     ...
     * actually close this {@link DelegatingResultSet}.
     *
     ...
     * actually close this {@link DelegatingResultSet}; {@code false}
     * in all other cases
     *
