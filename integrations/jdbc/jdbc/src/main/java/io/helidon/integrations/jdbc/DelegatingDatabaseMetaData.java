 ...
 * target="_parent">JDBC 4.3</a>-compliant {@link DatabaseMetaData}
...
public class DelegatingDatabaseMetaData implements DatabaseMetaData {
    ...
    public ResultSet getProcedureColumns(String catalog,
        ...
        throws SQLException {
        return this.delegate.getProcedureColumns(catalog, schemaPattern, procedureNamePattern, columnNamePattern);
    }
    ...
    public ResultSet getCrossReference(String parentCatalog,
                                       ...
                                       String foreignTable)
        throws SQLException {
        return this.delegate.getCrossReference(parentCatalog,
                                               parentSchema,
                                               parentTable,
                                               foreignCatalog,
                                               foreignSchema,
    ...
    public ResultSet getFunctionColumns(String catalog,
                                        ...
                                        String columnNamePattern)
        throws SQLException {
        return this.delegate.getFunctionColumns(catalog, schemaPattern, functionNamePattern, columnNamePattern);
    }
